...
## colophon
This website is made with [Eleventy](https://www.11ty.dev/) (using the [Eleventy Duo template](https://eleventyduo.netlify.app/)) and deployed with Cloudflare Pages. Fonts used are Overpass Mono for the headers and [Atkinson Hyperlegible](https://www.brailleinstitute.org/freefont/) by the Braille Institute for the body text, served by [Bunny](https://fonts.bunny.net/about). Domain hosted with [porkbun](https://porkbun.com/), an oddly satisfying registrar. Zero analytics, I don't track anything. I have AI-scraping bots blocked to the best of my ability.
